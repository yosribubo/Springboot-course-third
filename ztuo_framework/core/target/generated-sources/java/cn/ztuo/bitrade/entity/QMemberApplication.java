...
public class QMemberApplication extends EntityPathBase<MemberApplication> {
    ...
    public final EnumPath<cn.ztuo.bitrade.enums.CredentialsType> type = createEnum("type", cn.ztuo.bitrade.enums.CredentialsType.class);

    public final DateTimePath<java.util.Date> updateTime = createDateTime("updateTime", java.util.Date.class);

    public final StringPath videoRandom = createString("videoRandom");
