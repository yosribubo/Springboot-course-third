...
public class QCoin extends EntityPathBase<Coin> {
    ...
    public final NumberPath<java.math.BigDecimal> cnyRate = createNumber("cnyRate", java.math.BigDecimal.class);
    ...
    public final StringPath masterAddress = createString("masterAddress");

    public final NumberPath<java.math.BigDecimal> maxDailyWithdrawRate = createNumber("maxDailyWithdrawRate", java.math.BigDecimal.class);
    ...
    public final NumberPath<java.math.BigDecimal> sgdRate = createNumber("sgdRate", java.math.BigDecimal.class);
