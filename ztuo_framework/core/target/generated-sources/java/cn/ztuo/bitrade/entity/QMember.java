...
public class QMember extends EntityPathBase<Member> {
    ...
    public final NumberPath<Long> generalizeTotal = createNumber("generalizeTotal", Long.class);
    ...
    public final NumberPath<Long> integration = createNumber("integration", Long.class);

    public final NumberPath<Long> inviterId = createNumber("inviterId", Long.class);

    public final NumberPath<Long> inviterParentId = createNumber("inviterParentId", Long.class);

    public final EnumPath<cn.ztuo.bitrade.constant.BooleanEnum> isChannel = createEnum("isChannel", cn.ztuo.bitrade.constant.BooleanEnum.class);

    public final StringPath jyPassword = createString("jyPassword");

    public final NumberPath<Integer> kycStatus = createNumber("kycStatus", Integer.class);
    ...
    public final EnumPath<cn.ztuo.bitrade.constant.BooleanEnum> loginLock = createEnum("loginLock", cn.ztuo.bitrade.constant.BooleanEnum.class);
